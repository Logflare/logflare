  ...
  describe "json_viewer/1" do
    test "renders simple map with string values" do
      ...
      <div class="tw-font-mono tw-text-sm ">
        <div class="tw-my-0.5">
        <button type="button" phx-click="[[&quot;toggle&quot;,{&quot;to&quot;:&quot;#user&quot;}],[&quot;toggle_class&quot;,{&quot;names&quot;:[&quot;tw-rotate-90&quot;]}]]" class="tw-bg-transparent tw-border-none tw-p-0 tw-absolute -tw-translate-x-3 tw-translate-y-0.5 tw-inline-block tw-mr-1 tw-text-white tw-text-xs tw-select-none tw-cursor-pointer tw-transition-transform tw-duration-100 tw-rotate-90">
        ▶
      </button>
        <span class="tw-text-json-tree-key">user:</span>
        <span class="tw-text-json-tree-label">Object</span>

        <div class="tw-pl-4" id="user">
          <div class="tw-my-0.5 tw-overflow-hidden" id="user--age">
        <span class="tw-text-json-tree-key">age:</span>
        <span class="tw-text-json-tree-string">&quot;30&quot;</span>
      </div><div class="tw-my-0.5 tw-overflow-hidden" id="user--name">
        <span class="tw-text-json-tree-key">name:</span>
        <span class="tw-text-json-tree-string">&quot;John&quot;</span>
      </div>
        </div>
      </div>
      </div>
      ...
      assert html == String.trim_trailing(expected)
    end
