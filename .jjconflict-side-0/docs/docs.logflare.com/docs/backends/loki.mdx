...
Loki must be configured to allow structured metadata. It is recommended to increase the default maximum number of structured metadata fields to 500 to accommodate larger log structures of different products.
