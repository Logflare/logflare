...
Mimic.copy(GoogleApi.PubSub.V1.Api.Projects)
Mimic.copy(GoogleApi.Storage.V1.Api.Objects)
Mimic.copy(Tesla)
...
Mimic.copy(Logflare.Backends.Adaptor.S3TablesAdaptor.CatalogManager)
Mimic.copy(Logflare.Backends.Adaptor.S3TablesAdaptor.Native)
