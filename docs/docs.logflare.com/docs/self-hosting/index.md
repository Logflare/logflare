...
| `LOGFLARE_READ_REPLICAS`                       | String, defaults to `nil`                                               | Comma-separated list of database read replica hostnames to distribute read queries across. If unset or empty, all queries go to the primary database. Example: `"replica1.example.com,replica2.example.com"`                                                         |
