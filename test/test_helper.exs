...
Mimic.copy(Logflare.Backends.Adaptor.ClickHouseAdaptor.NativeIngester.PoolSup)
Mimic.copy(Logflare.Backends.Adaptor.ClickHouseAdaptor.NativeIngester.PoolScaler)
