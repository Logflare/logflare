...
3. `private` - allows Management API access for account resources. 
4. `private:admin` - includes `private` access, and allows admin operations for team users and backends.
