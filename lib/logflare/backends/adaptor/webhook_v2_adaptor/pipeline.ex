defmodule Logflare.Backends.Adaptor.WebhookV2Adaptor.Pipeline do
  @moduledoc """
  Broadway pipeline for the webhook v2 adaptor.
  ...
  alias Logflare.Backends.Adaptor.WebhookV2Adaptor
  ...
  defp batch_size(_backend), do: WebhookV2Adaptor.default_batch_size()
  ...
  defp emit_dropped(backend_id, count, reason) do
    ...
    :telemetry.execute(
      ...
      %{count: count},
      %{backend_type: :webhook_v2, backend_id: backend_id, reason: reason}
    )
  end
