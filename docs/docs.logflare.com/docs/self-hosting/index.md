...
| `GOOGLE_DATASET_LOCATION`           | string, defaults to `US`    | Allows customization of region, where dataset is created in BigQuery. Defaults to the "US" multi-region. See https://docs.cloud.google.com/bigquery/docs/locations for a full list of options.      |
