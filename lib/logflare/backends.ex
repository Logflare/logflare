defmodule Logflare.Backends do
  @moduledoc false
  alias Logflare.Backends.{SourceBackend, SourceManager, SourceDispatcher}
  ...
  def create_source_backend(%Source{} = source, type \\ :bigqusery, config \\ %{}) do
    source
  ...
  def dispatch_ingest(log_events, source) do
    Registry.dispatch(SourceDispatcher, source.token, fn entries ->
